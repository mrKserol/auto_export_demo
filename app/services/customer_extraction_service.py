...
CUSTOMER_FIELDS = ("passport", "first_name", "last_name", "surname", "tin", "ipain")
...
def extract_customer_fields_from_response(response_json: dict) -> dict:
    ...
    _extract_from_flat_text(extracted_data, fields)
...
def _extract_from_flat_text(extracted_data: dict, fields: dict) -> None:
    text_parts: list[str] = []
    ...
    if "passport" not in fields or not fields["passport"]:
